...
POSITION_METHODS = {
    ...
    "mixed_odds_pos_linear": "mixed_odds_pos_linear_variance_overall_params",
    "mixed_odds_pos_conservative_alpha": "mixed_odds_pos_conservative_alpha_variance_overall_params",
}
