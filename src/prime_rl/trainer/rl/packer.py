...
class BasePacker(ABC):
    def __init__(
        ...
        # D5 fix: when True, every sample (event-bearing or not) is
        # routed through segmented_forward. The packer un-packs every
        # non-multimodal sample into its own micro-batch. See
        # prepare_batch in trainer/batch.py.
